...
draft()
    ...
    #-------2] finish roster UI
    #-------2.1] clear function
    #-------3] search function - started, have values needed to search database
    #-------4] pick made function
    #-------5] work on propogating database
        #contains- First Name, Last Name, Overall, Position
    #-------6] create in progress pages for Main Menu
    #7] switch draft windows in GUI and Main
    #8] print results to main draft page and set up UI there
    #9] finish basic UI for display page
    #10] commit message for v0.1: UI for draft is set up, player draft fuunction to be added soon. Then CPU draft to follow. 


    #-------add to position count and average
    #-------search function
    #-------import draft order with end of draft values
    #-------up roster size to 18
    #-------write to csv
    #should finish page functionality then perform 7 on down

    # add in biggest reaches and biggest falls for picks
    # add in biggest draft haul based on overalls number of players and team improvement
    # for non-fantasy drafts pull from non league list then add players selected and FAs to league list

    #Ben Simmons*(2nd)
    #KAT*(1st)
    #Joe Harris*(maybe a 5th round pick)
